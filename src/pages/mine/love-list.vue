...
export default {
    ...
    methods: {
       ...
       async getData(){
            ...
            this.loaded = false;
            var {data,total} = await this.$http.post('/api/product/collect-list',this.searchData);
        ...
        deleteConfirm(){
            ...
            this.$http.post('/api/product/delete-collect',{ids:[this.deleteItem.id],openid:this.openid}).then(
                (res)=>{
                    this.getData();
                    this.deleteShow = false;
